...
class _AddPengumumanPageState extends State<AddPengumumanPage> {
  ...
  if (_formKey.currentState!.validate()) {
    ...
    if (_filePengumuman == null || _selectedEvent == null || _tanggalPengumuman == null) {
      ScaffoldMessenger.of(context).showSnackBar(
    ...
    try {
      ...
      await _pengumumanController.createPengumuman(newPengumuman, _filePengumuman );
...
Future<String> _uploadFileToStorage(File file) async {
  try {
    ...
    Reference storageRef = FirebaseStorage.instance.ref().child('pengumuman/$fileName');
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                validator: (value) => value == null ? "Pilih salah satu event" : null,
              ),
              const SizedBox(height: 16),
              const Text("File Pengumuman", style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Row(
                children: [
                  ElevatedButton.icon(
                  ...
                  Text(
                    _filePengumuman != null ? _filePengumuman!.path.split('/').last : "No File Chosen",
                  ),
                ],
              ),
              const SizedBox(height: 16),
              ...
              Align(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text("Tambah Pengumuman", style: TextStyle(color: Colors.white, fontSize: 14)),
                ),
              ),
            ],
          ),
